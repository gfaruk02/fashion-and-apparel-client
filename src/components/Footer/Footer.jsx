...
const Footer = () => {
  ...
  <nav>
  <header className="footer-title text-green-900 font-semibold">Social</header> 
  ...
  <nav>
    <header className="footer-title text-green-900 font-semibold">Company</header> 
    <Link to="/">Home</Link>
  ...
  <nav>
    <header className="footer-title text-green-900 font-semibold">Legal</header> 
